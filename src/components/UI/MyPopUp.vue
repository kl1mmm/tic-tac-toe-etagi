<template>
    <div class="v-popup">
        ...
        <div class="nickname">
            ...
            <InputText :value="userName" @input="userName = $event.target.value" class="inp" type="text"
                       placeholder="Иванов Иван Иванович"></InputText>
        </div>
        <div class="lowBlock">
            <div class="age">
                <div class="text">Возраст</div>
                <InputText :value="userAge" @input="userAge = $event.target.value" class="inp" type="text"
                           placeholder="0"></InputText>
            </div>
            <div class="sex">
                <div class="text">Пол</div>
                <label>
                    <input class="inpSex" type='radio' value="Женский" @input="userSex = $event.target.value"
                           name='sex'>
                    <span class='woman'><img alt="Ж" class="picSex" src="@/components/UI/pics/FemaleSex.svg"></span>
                </label>
                <label>
                    <input class="inpSex" type='radio' value="Мужской" @input="userSex = $event.target.value"
                           name='sex'>
